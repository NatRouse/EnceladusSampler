...
% n_traj = 2*tau/dt+2;
l=1;
desired_traj = [zeros(1,traj_length); -(0:dt:dt*(traj_length-1))]'; %zeros(1, 126); zeros(1, 126);zeros(1, 126)]'; %Downward sine wave
% figure(4)
...
subplot(2,1,2)
hold on
plot(time, -q_hist(2,:).*cos(q_hist(3,:)));
